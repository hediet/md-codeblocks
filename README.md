...
| Package | Description |
|---------|-------------|
| [`@hediet/md-codeblock-extractor`](codeblock-extractor/) | CLI & library for extracting annotated code blocks |
...
```sh
pnpm install
pnpm --filter @hediet/md-codeblock-extractor run build
pnpm --filter @hediet/md-codeblock-extractor run test
```
